...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-full bg-white pb-11 dark:bg-neutral-950 md:px-10"
      ref={containerRef}
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-4xl md:text-5xl mb-4 text-center text-black dark:text-white">
          Why Take Guhuza Quizzes?
        </h2>
          ...
          {data.map((item, index) => (
            ...
            >
              ...
              <div className="relative pl-20 pr-4 md:pl-4 w-full">
                <h3 className="md:hidden block text-2xl mb-4 text-left font-bold text-neutral-900 dark:text-neutral-500">
                  {item.title}
                </h3>
                {item.content}{" "}
              </div>
